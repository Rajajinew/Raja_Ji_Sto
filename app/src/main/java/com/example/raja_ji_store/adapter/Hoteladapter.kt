...
class hoteladapter(var nList:List<hoteldata>,private val context: Context): RecyclerView.Adapter<hoteladapter.hotelItemHolder>() {
    ...
    fun setFilteredList(nList: List<hoteldata>){
        this.nList=nList
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): hotelItemHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.hotelitem,parent,false)
