...
class gromAdapter(var nList:List<groomdata>,private val context: Context): RecyclerView.Adapter<gromAdapter.hotelItemHolder>() {
    ...
    fun setFilteredList(nList: List<groomdata>){
        this.nList=nList
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): hotelItemHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.groomitem,parent,false)
