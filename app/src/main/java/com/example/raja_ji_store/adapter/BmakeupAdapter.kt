...
class bmakeupAdapter(var nList:List<bmakeupdata>,private val context: Context): RecyclerView.Adapter<bmakeupAdapter.resturntHolder>() {
    ...
    fun setFilteredList(nList: List<bmakeupdata>) {
        this.nList = nList
        notifyDataSetChanged()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): resturntHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.bmakeupitem, parent, false)
