...
class carbetadapter(var nList:List<carbetdata>,private val context: Context): RecyclerView.Adapter<carbetadapter.hotelItemHolder>() {
    ...
    fun setFilteredList(nList: List<carbetdata>){
        this.nList=nList
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): hotelItemHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.carbetitem,parent,false)
    ...
    @OptIn(UnstableApi::class) override fun onBindViewHolder(holder: hotelItemHolder, position: Int) {
