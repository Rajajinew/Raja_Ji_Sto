...
class Cookadapter(var nList:List<cookdata>,private val context: Context): RecyclerView.Adapter<Cookadapter.resturntHolder>() {
    ...
    fun setFilteredList(nList: List<cookdata>){
        this.nList=nList
        notifyDataSetChanged()
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): resturntHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.cookitem,parent,false)
